...
- [Project story requirements](project-story-requirements.md): version 1 is accepted and supported when merged into `main`; unmerged branch copies are proposals. Architecture decisions listed as pending remain unapproved.
