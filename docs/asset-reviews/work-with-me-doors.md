...
- Native-resolution inspection: pass. Each crop keeps its subject whole (the masthead and skyline; the name, tagline and desk scene; the Tally sidebar, safe-to-spend figure and budget bars) with no cut-off text along the edges that would read as a mistake. The Tally capture shows a fictional household and no real account, person or amount.
