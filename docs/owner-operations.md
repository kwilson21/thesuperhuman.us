...
Studio data has a separate first step. Codes and expired, revoked, or inactive sessions become eligible 30 days after they stop being useful. Access and project audit rows become eligible after two years. For a withdrawn or declined project without an active payment, private content is eligible 30 days after closure. Delivered project content becomes eligible 30 days after the last final file's one-year access period. Pending multipart uploads block project cleanup until the owner discards them. This is manual cleanup; the published privacy notice must say so. Run it at least monthly while the portal is in use:
