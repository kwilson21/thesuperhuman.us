...
const requiredSchema = ['owner_campaigns', 'owner_requests', 'owner_request_audit', 'owner_audience_permissions', 'music_playback_events', 'music_playback_daily', 'owner_retention_runs'];
